<?php
   ...
   class API extends REST{
    ...
    const DB_USER = "privytex_const";
    const DB_PASSWORD = "4DC[.(DV]]&b";
    const DB = "privytex_construct";
         ...
         if ($_SERVER['REQUEST_METHOD'] == 'GET'){
	       ...
	       if ($this->path_params[3] == "list") {
                  if ($this->path_params[4] != null) {
                     ...
                     if ($this->path_params[4] != null) {
                        //if ($this->path_params[4] == "check") {
                        $sql = mysql_query("SELECT * FROM `dailyInspectionForm` WHERE inspectionID = '".mysql_real_escape_string($this->path_params[5])."'", $this->db);
                        if(mysql_num_rows($sql) > 0){
                           //$row = mysql_fetch_assoc($sql);
                           while ($user = mysql_fetch_assoc($sql)) {
            ...
            if ($this->path_params[3] != null) {
               if($this->path_params[3] == "create"){
                  ...
                  $sql = mysql_query("SELECT inspectionID FROM dailyInspectionForm 
                                          ORDER BY id DESC LIMIT 1", $this->db);
                  
                  $user = mysql_fetch_assoc($sql);
                  $lastID = $user['inspectionID'];
                  ...
                  //if(mysql_num_rows($sql) == 0){
					 ...
					 for($i=1; $i < 5; $i++){
						 if(!empty($iNo[$i])){
							$query = mysql_query("INSERT INTO `dailyInspection_item`(`inspectionID`, `No`, `Description`, `Qty`, `date`)
                  ...
                  //}
                     ...
                     if ($this->path_params[4] != null) {
                           ...
                           if($this->path_params[5] != null){
                              $sql = mysql_query("SELECT images_uploaded FROM dailyInspectionForm
                                                   WHERE inspectionID = '".mysql_real_escape_string($this->path_params[5])."'", $this->db);
                              $row = mysql_fetch_assoc($sql);
                              $currentImage = $row['images_uploaded'].','.mysql_real_escape_string($this->path_params[6]);
                              
                              $query = mysql_query("UPDATE dailyInspectionForm SET images_uploaded='".$currentImage."' WHERE inspectionID='".mysql_real_escape_string($this->path_params[5])."'");
                              //$sql = mysql_query("SELECT * FROM loginfo WHERE user_name = 'ranjana'");
                     ...
                     if ($this->path_params[4] != null) {
                           ...
                           if($this->path_params[5] != null){
                              ...
                              $query = mysql_query("UPDATE dailyInspectionForm SET sketch_images='".$currentImage."' WHERE inspectionID='".mysql_real_escape_string($this->path_params[5])."'");
                              //$sql = mysql_query("SELECT * FROM loginfo WHERE user_name = 'ranjana'");
         ...
         if ($_SERVER['REQUEST_METHOD'] == 'GET'){
	       ...
	       if ($this->path_params[3] == "list") {
                  ...
                  if ($this->path_params[4] != null) {
                     ...
                     if ($this->path_params[4] != null) {
                        //if ($this->path_params[4] == "check") {
                        $sql = mysql_query("SELECT * FROM `nonComplianceForm` WHERE Non_ComplianceNoticeNo = '".mysql_real_escape_string($this->path_params[5])."'", $this->db);
                        if(mysql_num_rows($sql) > 0){
                           //$row = mysql_fetch_assoc($sql);
                           while ($user = mysql_fetch_assoc($sql)) {
            ...
            if ($this->path_params[3] != null) {
               if($this->path_params[3] == "create"){
                  $sql = mysql_query("SELECT Non_ComplianceNoticeNo FROM nonComplianceForm 
                                          ORDER BY id DESC LIMIT 1", $this->db);
                  
                  $user = mysql_fetch_assoc($sql);
                  $lastID = $user['Non_ComplianceNoticeNo'];
                  ...
                  $newID = 'CN'.$newID;
                     ...
                     $query = mysql_query("INSERT INTO `nonComplianceForm`(`Non_ComHeader`, `ContractNo`, `Non_ComplianceNoticeNo`, `ProjectDescription`,
                     ...
                     if ($this->path_params[4] != null) {
                           ...
                           if($this->path_params[5] != null){
                              $sql = mysql_query("SELECT images_uploaded FROM nonComplianceForm
                                                   WHERE Non_ComplianceNoticeNo = '".mysql_real_escape_string($this->path_params[5])."'", $this->db);
                              $row = mysql_fetch_assoc($sql);
                              $currentImage = $row['images_uploaded'].','.mysql_real_escape_string($this->path_params[6]);
                              
                              $query = mysql_query("UPDATE nonComplianceForm SET images_uploaded='".$currentImage."' WHERE Non_ComplianceNoticeNo='".mysql_real_escape_string($this->path_params[5])."'");
                              //$sql = mysql_query("SELECT * FROM loginfo WHERE user_name = 'ranjana'");
                     ...
                     if ($this->path_params[4] != null) {
                           ...
                           if($this->path_params[5] != null){
                              ...
                              $query = mysql_query("UPDATE nonComplianceForm SET sketch_images='".$currentImage."' WHERE Non_ComplianceNoticeNo='".mysql_real_escape_string($this->path_params[5])."'");
                              //$sql = mysql_query("SELECT * FROM loginfo WHERE user_name = 'ranjana'");
         ...
         if ($_SERVER['REQUEST_METHOD'] == 'GET'){
		   ...
		   $result = array();
				  ...
				  $sqla = "SELECT `No`, `Description`, `P_O_Box`, `Qty`, dailyInspection_item.`date` FROM `dailyInspection_item`
								LEFT JOIN dailyInspectionForm ON dailyInspectionForm.`inspectionID` = dailyInspection_item.`inspectionID`
			   ...
			   if ($this->path_params[4] != null) {
				$sqla = "SELECT `quantity_summary_details`.*, `printedName`, `Date` FROM `quantity_summary_details`
									INNER JOIN `dailyInspectionForm` ON quantity_summary_details.project_id = dailyInspectionForm.`Project_id`
                                           WHERE quantity_summary_details.`project_id` = '".mysql_real_escape_string($this->path_params[5])."'
										    GROUP BY quantity_summary_details.`project_id` ORDER BY quantity_summary_details.`id` ASC";
				$sql = mysql_query($sqla);
				//echo $sqla;	 						   
					if(mysql_num_rows($sql) > 0){
					while ($row1 = mysql_fetch_assoc($sql)) {
					  ...
					  if ($this->path_params[4] != null) {
					  $sqlb = "SELECT `project`, `item_no`, `est_qty`, `unit`, `unit_price`, `Description` FROM `quantity_summary_details`
									LEFT JOIN `dailyInspection_item` ON dailyInspection_item.`No` = quantity_summary_details.`item_no`
                                           WHERE quantity_summary_details.`id` = '".mysql_real_escape_string($this->path_params[5])."' GROUP BY quantity_summary_details.`id`";
	       ...
	       if ($this->path_params[3] == "save") {
					...
					$query = mysql_query("INSERT INTO `quantity_summary_details`(`project_id`, `project`, `item_no`, `est_qty`, `unit`, `unit_price`)
									VALUES (
										  '".mysql_real_escape_string($this->path_params[4])."',
										  '".mysql_real_escape_string($this->path_params[5])."',
                                          '".mysql_real_escape_string($this->path_params[6])."',
   ...
   public function summary1(){
         if ($_SERVER['REQUEST_METHOD'] == 'GET'){
	       ...
	       if ($this->path_params[3] == "list") {
                  if ($this->path_params[4] != null) {
                     $sql = mysql_query("SELECT * FROM `summarySheet1`
                                        INNER JOIN assign_project
                                        ON assign_project.`projectid` = summarySheet1.project_id 
                                           WHERE assign_project.`username` = '".mysql_real_escape_string($this->path_params[4])."' AND
                                           `Project_id` = '".mysql_real_escape_string($this->path_params[5])."' ", $this->db);
                     if(mysql_num_rows($sql) > 0){
                        //$row = mysql_fetch_array($sql);
                  ...
                  if ($this->path_params[4] != null) {
                     ...
                     if ($this->path_params[4] != null) {
                        ...
                        $sql = mysql_query("SELECT * FROM `summarySheet1`
                                           ...
                                           ON summarySheet2.`SMSSheetNo` = summarySheet1.SMSheetNo
                                           INNER JOIN summarySheet3
                                           ON summarySheet3.`SMSheetNo` = summarySheet1.SMSheetNo
                                           WHERE summarySheet1.SMSheetNo = '".mysql_real_escape_string($this->path_params[4])."'", $this->db);
                        if(mysql_num_rows($sql) > 0){
                           //$row = mysql_fetch_assoc($sql);
                           while ($user = mysql_fetch_assoc($sql)) {
                     ...
                     if ($this->path_params[4] != null) {
                        ...
                        $sql = mysql_query("SELECT * FROM `summarySheet1`
                                           ...
                                           INNER JOIN summarySheet3
                                           ON summarySheet3.`SMSheetNo` = summarySheet1.SMSheetNo
                                           WHERE summarySheet1.SMSheetNo = '".mysql_real_escape_string($this->path_params[5])."'", $this->db);
                        if(mysql_num_rows($sql) > 0){
                           //$row = mysql_fetch_assoc($sql);
                           while ($user = mysql_fetch_assoc($sql)) {
                              $result['expenseReport'] = $user;
            ...
            if ($this->path_params[3] != null) {
               if($this->path_params[3] == "create"){
                  $sql = mysql_query("SELECT SMSheetNo FROM summarySheet1 
                                          ORDER BY id DESC LIMIT 1", $this->db);
                  
                  $user = mysql_fetch_assoc($sql);
                  $lastID = $user['SMSheetNo'];
                  ...
                  $newID = 'SM'.$newID;
                     ...
                     $query = mysql_query("INSERT INTO `summarySheet1`(`SMSheetNo`, `Project_id`, `SSHeader`, `Contractor`, `POBox`, `City`, `State`, `zip`,
         ...
         if ($_SERVER['REQUEST_METHOD'] == 'GET'){
	       ...
	       if ($this->path_params[3] == "list") {
                  if ($this->path_params[4] != null) {
                     ...
                     if ($this->path_params[4] != null) {
                        //if ($this->path_params[4] == "check") {
                        $sql = mysql_query("SELECT * FROM `summarySheet3` WHERE SMSheetNo = '".mysql_real_escape_string($this->path_params[5])."'", $this->db);
                        if(mysql_num_rows($sql) > 0){
                           //$row = mysql_fetch_assoc($sql);
                           while ($user = mysql_fetch_assoc($sql)) {
                              $result['expenseReport'] = $user;
            ...
            if ($this->path_params[3] != null) {
               if($this->path_params[3] == "create"){
                     ...
                     $query = mysql_query("INSERT INTO `summarySheet3`(`SMSheetNo`, `Project_id`, `EQSizeandClass1`, `EQIdleActive1`, `EQNo1`, `EQTotalHours1`,
   ...
   public function expense(){
         if ($_SERVER['REQUEST_METHOD'] == 'GET'){
	       ...
	       if ($this->path_params[3] == "list") {
                  if ($this->path_params[4] != null) {
                     $sql = mysql_query("SELECT * FROM `expenseReport`
                                        INNER JOIN assign_project
                                        ON assign_project.`projectid` = expenseReport.project_id
                                         WHERE assign_project.`username` = '".mysql_real_escape_string($this->path_params[4])."' AND
                                           `Project_id` = '".mysql_real_escape_string($this->path_params[5])."' ", $this->db);
                     if(mysql_num_rows($sql) > 0){
                        //$row = mysql_fetch_array($sql);
                        while ($row = mysql_fetch_assoc($sql)) {
                           $result['expenseReport'][]=$row;
                        }
...
$total =0;
                  if ($this->path_params[4] != null) {
                     ...
                     if ($this->path_params[4] != null) {
                        //if ($this->path_params[4] == "check") {
                        $sql = mysql_query("SELECT * FROM `expenseReport` WHERE EXReportNo = '".mysql_real_escape_string($this->path_params[4])."'", $this->db);
                        if(mysql_num_rows($sql) > 0){
                           //$row = mysql_fetch_assoc($sql);
                           while ($user = mysql_fetch_assoc($sql)) {
                              $result['expenseReport'] = $user;
   ...
   public function compliance(){
         if ($_SERVER['REQUEST_METHOD'] == 'GET'){
	       ...
	       if ($this->path_params[3] == "list") {
                  ...
                  //if ($this->path_params[4] == "check") {
                        $sql = mysql_query("SELECT * FROM `complianceForm` WHERE ComplianceNoticeNo = '".mysql_real_escape_string($this->path_params[5])."'", $this->db);
                        if(mysql_num_rows($sql) > 0){
                           $row = mysql_fetch_assoc($sql);
                           //while ($user = mysql_fetch_assoc($sql)) {
                              $result['ComplianceNoticeNo'] = $row;
                           //}
                           $result[] = array('status' => "sucess");
                           // If success everythig is good send header as "OK" and user details
                           $this->response($this->json($result), 200);
            ...
            if ($this->path_params[3] != null) {
               if($this->path_params[3] == "create"){
                  $sql = mysql_query("SELECT ComplianceNoticeNo FROM complianceForm 
                                          ORDER BY ComplianceNoticeNo DESC LIMIT 1", $this->db);
                  
                  $user = mysql_fetch_assoc($sql);
                  $lastID = $user['ComplianceNoticeNo'];
                  $lastID = str_replace('CN', '', $lastID);
                  $newID = $lastID + 1;
                  $newID = 'CN'.$newID;
                     ...
                     $query = mysql_query("INSERT INTO `complianceForm`(`comHeader`, `ContractNo`, `ComplianceNoticeNo`, `ProjectDescription`, `Title`,
                     ...
                     if ($this->path_params[4] != null) {
                           ...
                           if($this->path_params[5] != null){
                              $sql = mysql_query("SELECT images_uploaded FROM complianceForm
                                                   WHERE ComplianceNoticeNo = '".mysql_real_escape_string($this->path_params[5])."'", $this->db);
                              $row = mysql_fetch_assoc($sql);
                              $currentImage = $row['images_uploaded'].','.mysql_real_escape_string($this->path_params[6]);
                              
                              $query = mysql_query("UPDATE complianceForm SET images_uploaded='".$currentImage."' 
                                                   WHERE ComplianceNoticeNo='".mysql_real_escape_string($this->path_params[5])."'");
                              //$sql = mysql_query("SELECT * FROM loginfo WHERE user_name = 'ranjana'");
